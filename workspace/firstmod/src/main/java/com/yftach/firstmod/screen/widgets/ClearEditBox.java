...
public class ClearEditBox extends AbstractWidget implements Widget, GuiEventListener {
   ...
   private static final int BACKGROUND_COLOR = 139;
   ...
   public void renderButton(PoseStack pPoseStack, int pMouseX, int pMouseY, float pPartialTick) {
      if (this.isVisible()) {
         if (this.isBordered()) {
            fill(pPoseStack, this.x - 1, this.y - 1, this.x + this.width + 1, this.y + this.height + 1, BACKGROUND_COLOR);
            fill(pPoseStack, this.x, this.y, this.x + this.width, this.y + this.height, BACKGROUND_COLOR);
         }
