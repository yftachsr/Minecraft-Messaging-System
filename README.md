...
Important to note that if you choose to run the mod by the second option, the message will never show who writen the message because your player UUID in this environment is not real.
